...
public class Constants {
    public static final String GET_MAIN_ARTICLE_LOADMORE = "GET_MAIN_ARTICLE_LOADMORE";
    public static final String GET_MAIN_ARTICLE_REFRESH = "GET_MAIN_ARTICLE_REFRESH";
